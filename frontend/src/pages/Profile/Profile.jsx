...
export default function Profile() {
    ...
    if (loading) {
        return (
            <div
                className={`min-h-screen p-4 md:p-8 flex justify-center transition-colors duration-300 ${darkMode ? "bg-slate-950" : "bg-slate-50"
                    }`}
            >
                <ProfileSkeleton />
            </div>
    ...
    return (
        <div
            className={`min-h-screen p-4 md:p-8 flex justify-center text-left transition-colors duration-300 ${darkMode
